...
function Cont(){
   ...
   <>
   <Box >
  <img src={Contact} style={{position: 'absolute',width:'100%',transform: 'translate(-50%, -50%)',
          zIndex: 1,top:'516%',left:'50%'}}/>
                    <Typography
        sx={{
          position: 'absolute',
          top: '505%', 
      ...
      <Box variant="contained"
       ...
       paddingTop:'10px',
        ...
        fontFamily:'DM Sans',color:'white'}}>info@veridian.com</Typography> 
